...
public class FlowLayout02 extends ViewGroup {
...
//   private Scroller mScroller;
    ...
    public FlowLayout02(Context context) {
        this(context, null);
    }

    public FlowLayout02(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayout02(Context context, AttributeSet attrs, int defStyle) {
